        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
          ...
          <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-transparent overflow-hidden text-center">
            ...
            <div className="mt-6">
              ...
              <p className="text-slate-400 mt-3">
                Mantén una temperatura fresca y confortable en todo momento para
                un descanso óptimo.
              </p>
            </div>
          </div>
          ...
          <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-transparent overflow-hidden text-center">
            ...
            <div className="mt-6">
              ...
              <p className="text-slate-400 mt-3">
                Mantente conectado en todo momento con nuestro servicio de wifi
                gratuito y de alta velocidad.
              </p>
            </div>
          </div>
          ...
          <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-transparent overflow-hidden text-center">
            ...
            <div className="mt-6">
              ...
              <p className="text-slate-400 mt-3">
                Tu comodidad es nuestra prioridad, con habitaciones equipadas y
                servicios que harán que te sientas como en casa.
              </p>
            </div>
          </div>
        </div>
